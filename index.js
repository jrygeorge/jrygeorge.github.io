...
if(window.mobileAndTabletCheck()){document.getElementsByTagName("h4")[0].textContent = "just some physics and graphics-y things";}
...
columnNumber = Math.floor(window.innerWidth/300);
